...
class AccountsApi {
   ...
   */
   public function createFundingSourcesToken($id, $headers = null) {
      ...
      // verify the required parameter 'id' is set
      if ($id === null) {
        throw new \InvalidArgumentException('Missing the required parameter $id when calling createFundingSourcesToken');
      }
      

      // parse inputs
      $resourcePath = "/accounts/{id}/funding-sources-token";
      $resourcePath = str_replace("{format}", "json", $resourcePath);
      $method = "POST";
      $httpBody = '';
      $queryParams = array();
      ...
      return $response[0] == 201 ? $response[1] : $this->apiClient->deserialize($response[1],'AccountOAuthToken');
  }
